...
// CDC BMI-for-age percentile table (P5, P50, P85, P95) — ages 2–18
const cdcMale: Record<number, [number, number, number, number]> = {
  2:  [14.7, 16.0, 17.4, 18.4],
  3:  [14.3, 15.7, 17.0, 18.0],
  4:  [14.1, 15.5, 16.8, 17.8],
  5:  [14.0, 15.4, 16.8, 18.0],
  6:  [13.9, 15.4, 17.0, 18.5],
  7:  [14.0, 15.6, 17.4, 19.3],
  8:  [14.2, 15.9, 18.0, 20.2],
  9:  [14.4, 16.4, 18.8, 21.3],
  10: [14.7, 16.9, 19.6, 22.3],
  11: [15.1, 17.6, 20.5, 23.4],
  12: [15.5, 18.2, 21.2, 24.2],
  13: [16.0, 18.9, 22.0, 25.1],
  14: [16.5, 19.7, 22.8, 25.9],
  15: [17.1, 20.5, 23.5, 26.8],
  16: [17.6, 21.2, 24.1, 27.5],
  17: [18.0, 21.7, 24.6, 28.0],
  18: [18.5, 22.2, 25.2, 28.6],
};

const cdcFemale: Record<number, [number, number, number, number]> = {
  2:  [14.3, 15.7, 17.1, 18.0],
  3:  [13.9, 15.4, 16.7, 17.7],
  4:  [13.6, 15.2, 16.5, 17.6],
  5:  [13.5, 15.2, 16.6, 17.9],
  6:  [13.5, 15.3, 17.0, 18.5],
  7:  [13.6, 15.6, 17.6, 19.4],
  8:  [13.9, 16.1, 18.4, 20.6],
  9:  [14.2, 16.7, 19.2, 21.8],
  10: [14.6, 17.5, 20.1, 23.0],
  11: [15.1, 18.4, 21.1, 24.2],
  12: [15.7, 19.2, 22.0, 25.3],
  13: [16.3, 20.0, 22.8, 26.2],
  14: [16.9, 20.7, 23.5, 27.0],
  15: [17.5, 21.2, 24.0, 27.6],
  16: [17.9, 21.7, 24.4, 28.0],
  17: [18.2, 22.0, 24.7, 28.4],
  18: [18.5, 22.5, 25.0, 28.6],
};
...
export const anakT: Record<Lang, Tx> = {
  id: {
    ...
    female: "Perempuan",
    age: "Usia (tahun)",
    agePlaceholder: "contoh: 10",
    ageNote: "Berlaku untuk anak usia 2–18 tahun",
    weightLabel: "Berat Badan (kg)",
    weightPlaceholder: "contoh: 30",
    heightLabel: "Tinggi Badan (cm)",
    heightPlaceholder: "contoh: 135",
    calculate: "Hitung BMI Anak",
    recalculate: "Hitung Ulang",
    bmiLabel: "BMI Anak",
    categoryLabel: "Kategori",
    idealWeightLabel: "Berat Badan Ideal",
    idealWeightNote: "Berdasarkan persentil 5–85 CDC untuk usia & tinggi ini",
    categories: {
      underweight: {
        label: "Kekurangan Berat Badan",
        color: "text-blue-600",
        bg: "bg-blue-50 border-blue-200",
        tip: "Berat badan anak di bawah persentil ke-5. Konsultasikan dengan dokter anak untuk evaluasi nutrisi lebih lanjut.",
      },
      normal: {
        label: "Berat Badan Normal",
        color: "text-emerald-600",
        bg: "bg-emerald-50 border-emerald-200",
        tip: "Berat badan anak dalam rentang sehat. Pertahankan dengan pola makan bergizi dan aktivitas fisik yang cukup.",
      },
      overweight: {
        label: "Kelebihan Berat Badan",
        color: "text-amber-600",
        bg: "bg-amber-50 border-amber-200",
        tip: "Berat badan anak di atas persentil ke-85. Kurangi makanan tinggi gula dan ajak lebih banyak bergerak.",
      },
      obese: {
        label: "Obesitas",
        color: "text-red-600",
        bg: "bg-red-50 border-red-200",
        tip: "Berat badan anak di atas persentil ke-95. Sangat disarankan konsultasi dengan dokter anak.",
      },
    },
  ...
  en: {
    ...
    ageNote: "For children aged 2–18 years",
    weightLabel: "Weight (kg)",
    weightPlaceholder: "e.g. 30",
    heightLabel: "Height (cm)",
    heightPlaceholder: "e.g. 135",
    calculate: "Calculate Child's BMI",
    recalculate: "Recalculate",
    bmiLabel: "Child's BMI",
    categoryLabel: "Category",
    idealWeightLabel: "Ideal Weight Range",
    idealWeightNote: "Based on CDC 5th–85th percentile for this age & height",
    categories: {
      underweight: {
        label: "Underweight",
        color: "text-blue-600",
        bg: "bg-blue-50 border-blue-200",
        tip: "Child's weight is below the 5th percentile. Consult a pediatrician for a nutritional evaluation.",
      },
      normal: {
        label: "Healthy Weight",
        color: "text-emerald-600",
        bg: "bg-emerald-50 border-emerald-200",
        tip: "Child's weight is in the healthy range. Maintain with nutritious meals and adequate physical activity.",
      },
      overweight: {
        label: "Overweight",
        color: "text-amber-600",
        bg: "bg-amber-50 border-amber-200",
        tip: "Child's weight is above the 85th percentile. Reduce sugary foods and encourage more physical activity.",
      },
      obese: {
        label: "Obese",
        color: "text-red-600",
        bg: "bg-red-50 border-red-200",
        tip: "Child's weight is above the 95th percentile. A pediatrician consultation is strongly recommended.",
      },
    },
...
export default function AnakCalculator({ lang }: { lang: Lang }) {
  ...
  function calculate(e: React.FormEvent) {
    ...
    // Ideal weight: weight that gives BMI between P5 and P85
    const idealMin = Math.round(p5 * heightM * heightM * 10) / 10;
    const idealMax = Math.round(p85 * heightM * heightM * 10) / 10;

    const category = getCategory(bmi, a, gender, tx);
    setResult({ bmi: Math.round(bmi * 10) / 10, category, idealMin, idealMax });
  }

  const liveCategory =
    result
      ? getCategory(result.bmi, Math.round(parseFloat(age)), gender, anakT[lang])
      : null;
    ...
    <div className="w-full">
      <form onSubmit={calculate} className="space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            <label htmlFor="age" className="block text-sm font-medium text-emerald-800 mb-2">
              {tx.age}
            </label>
            <input
              id="age"
          ...
          <div>
            <label htmlFor="height" className="block text-sm font-medium text-emerald-800 mb-2">
              {tx.heightLabel}
            </label>
            <input
              id="height"
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className={`rounded-3xl border-2 p-5 sm:p-6 ${liveCategory.bg}`}>
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="text-right">
                ...
                <p className={`text-lg font-bold ${liveCategory.color}`}>
                  {liveCategory.label}
                </p>
              </div>
            </div>
          ...
          <div className="rounded-2xl border-2 border-emerald-100 bg-white p-5">
            ...
            <p className="text-4xl font-black text-emerald-700">
              {result.idealMin}–{result.idealMax}
              <span className="text-xl font-normal text-emerald-400 ml-1">kg</span>
            </p>
